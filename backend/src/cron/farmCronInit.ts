...
export function initFarmCrons(): void {
  ...
  FarmSettings.findOne({ key: 'digital_farm' }).then(async (s) => {
    ...
    const SEBZE_CATALOG = [
      { crop_type: 'domates', display_name: 'Domates', seed_cost_per_m2: 3, min_area_m2: 5, growth_days: 75, yield_per_m2_kg: 3.5, season_start_month: 3, season_end_month: 8, water_frequency_hours: 24, fertilize_frequency_days: 7, icon_emoji: '🍅' },
      { crop_type: 'biber', display_name: 'Biber', seed_cost_per_m2: 4, min_area_m2: 5, growth_days: 65, yield_per_m2_kg: 2.8, season_start_month: 4, season_end_month: 9, water_frequency_hours: 20, fertilize_frequency_days: 7, icon_emoji: '🌶️' },
      { crop_type: 'salatalik', display_name: 'Salatal\u0131k / Korni\u015fon', seed_cost_per_m2: 2.5, min_area_m2: 5, growth_days: 55, yield_per_m2_kg: 4.0, season_start_month: 4, season_end_month: 9, water_frequency_hours: 18, fertilize_frequency_days: 5, icon_emoji: '🥒' },
      { crop_type: 'patlican', display_name: 'Patl\u0131can', seed_cost_per_m2: 3.5, min_area_m2: 5, growth_days: 70, yield_per_m2_kg: 3.0, season_start_month: 4, season_end_month: 9, water_frequency_hours: 22, fertilize_frequency_days: 7, icon_emoji: '🍆' },
      ...
      { crop_type: 'marul', display_name: 'Marul / Ye\u015fil Salata', seed_cost_per_m2: 1.5, min_area_m2: 3, growth_days: 35, yield_per_m2_kg: 2.5, season_start_month: 3, season_end_month: 10, water_frequency_hours: 12, fertilize_frequency_days: 7, icon_emoji: '🥬' },
      { crop_type: 'ispanak', display_name: '\u0130spanak', seed_cost_per_m2: 1.5, min_area_m2: 3, growth_days: 40, yield_per_m2_kg: 2.0, season_start_month: 9, season_end_month: 4, water_frequency_hours: 18, fertilize_frequency_days: 10, icon_emoji: '🥬' },
      { crop_type: 'havuc', display_name: 'Havu\u00e7', seed_cost_per_m2: 2, min_area_m2: 3, growth_days: 70, yield_per_m2_kg: 3.0, season_start_month: 3, season_end_month: 9, water_frequency_hours: 24, fertilize_frequency_days: 10, icon_emoji: '🥕' },
      { crop_type: 'sogan', display_name: 'So\u011fan', seed_cost_per_m2: 1.5, min_area_m2: 3, growth_days: 90, yield_per_m2_kg: 3.5, season_start_month: 2, season_end_month: 5, water_frequency_hours: 36, fertilize_frequency_days: 14, icon_emoji: '🧅' },
    ];
    ...
    const defaultRegions = [
      {
        ...
        description: 'Mut\u2019un verimli ovalar\u0131nda organik sebze yeti\u015ftirme alan\u0131. Damla sulama sistemi, g\u00fcbre deposu ve saha ekibi mevcut.',
        is_active: true,
      },
      {
        region_id: 'antalya-sera-01',
        region_name: 'Antalya Sera Tarlas\u0131',
        ...
        description: 'Antalya Kumluca\u2019da kontroll\u00fc sera ortam\u0131nda sebze \u00fcretimi. Y\u0131l boyunca ekim m\u00fcmk\u00fcn.',
        is_active: true,
      },
      {
        region_id: 'adana-cukurova-01',
        region_name: '\u00c7ukurova Sebze Alan\u0131',
        city_code: '01', city_name: 'Adana', district: 'Y\u00fcre\u011fir',
        ...
        description: 'T\u00fcrkiye\u2019nin en verimli tar\u0131m ovas\u0131 \u00c7ukurova\u2019da geni\u015f sebze \u00fcretim alan\u0131.',
        is_active: true,
      },
      {
        ...
        description: 'Marmara b\u00f6lgesinin serin iklimine uygun ye\u015fil yaprakl\u0131 sebzeler ve k\u00f6k sebzeler.',
        is_active: true,
      },
    ];
