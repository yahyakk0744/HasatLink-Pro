  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 animate-fade-in">
      ...
      <div className="flex items-center gap-3 mb-2">
        <div className="w-10 h-10 bg-[color-mix(in_srgb,var(--accent-green)_10%,transparent)] rounded-xl flex items-center justify-center">
      ...
      <form onSubmit={handleSubmit} className="mt-6 surface-card rounded-2xl p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            className="w-full px-4 py-3 rounded-xl bg-[var(--bg-input)] text-[var(--text-primary)] placeholder-[var(--text-secondary)] text-sm focus:outline-none focus:ring-2 focus:ring-[color-mix(in_srgb,var(--accent-green)_30%,transparent)] focus:bg-[var(--focus-bg)] transition-all resize-none"
