...
export default function AIDiagnosisPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 animate-fade-in">
      <SEO
        title={t('ai.title')}
        description="Yapay zeka destekli bitki hastalığı teşhisi. Bitkilerinizin fotoğrafını yükleyin, AI analiz etsin."
        keywords="ai, yapay zeka, bitki hastalığı, teşhis, tarım"
      />
