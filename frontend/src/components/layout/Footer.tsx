              ...
              <div className="flex items-center gap-6 bg-gradient-to-r from-[#2D6A4F]/20 to-[#1B4332]/20 border border-[#2D6A4F]/30 rounded-2xl p-6">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-semibold">
                    {isTr ? 'HasatLink Uygulamasını Yükle' : 'Install HasatLink App'}
                  </h4>
                  <p className="text-xs text-white/60 mt-0.5">
                    {isTr ? 'Hızlı erişim ve bildirimler için ana ekrana ekleyin' : 'Add to home screen for quick access and notifications'}
                  </p>
                </div>
                <button
                  onClick={handleInstallPWA}
